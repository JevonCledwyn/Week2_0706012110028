...
import com.example.week2_0706012110028.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {
    private val adapter = ListRVAdapter(listDataHewan)
    private var adapter2 = ListRVAdapter(filterjenishewan)
